...
- Check for active workstreams (**workstream**) and objectives if `.eng/` exists.
...
- Brief each specialist: full scope, entry points, context, and constraints per **orchestration**.
- Fire independent subs in parallel.
- Record what you sent and to whom in the whiteboard.
- Follow **docs** conventions for any `.eng/` files.
