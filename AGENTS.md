...
| `eng-review` | Gate review, verification, and final sign-off workflows | `SKILL.md`, `references/` |
| `eng-workflow` | Workflow phases, status values, gate checklists, whiteboard/objective entry | `SKILL.md`, `references/` |
