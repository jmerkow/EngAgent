...
1. Check the gate. Status must be >= `in-progress` (see **eng-workflow** ordinals). If not, refuse and point the user back to implementation.
...
6. Route outcomes:
   - All pass -> suggest final sign-off mode in **eng-review**.
